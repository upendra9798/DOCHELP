...
const HomePage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-160px)] pt-20 px-4 flex flex-col items-center text-center ">
      <div>
        ...
        <div className="mt-10 flex flex-wrap justify-center items-center gap-6 px-4">
          <img
            src="/homeImg1.jpg"
            alt="Skin 1"
            className="h-72 w-80 object-cover rounded shadow"
          />
          <img
            src="/homeImg2.jpg"
            alt="Skin 2"
        ...
        <section className="mt-20 px-4 max-w-6xl mx-auto bg-white p-5 rounded-lg shadow-md">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {tools.map((tool, index) => (
              <div
                key={index}
                className="border rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all bg-white"
              >
